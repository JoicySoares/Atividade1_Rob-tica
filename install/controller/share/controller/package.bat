...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\controller\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\controller\hook\ament_prefix_path.bat"
